...
Once you have edited your template and code you can use the following command lines to deploy your application from the command line (these examples assume the project name is *ServerlessUserApi*):

Restore dependencies
```
    cd "ServerlessUserApi"
    dotnet restore
```

Execute unit tests
```
    cd "ServerlessUserApi/test/ServerlessUserApi.Tests"
    dotnet test
```

Deploy application
```
    cd "ServerlessUserApi/src/ServerlessUserApi"
