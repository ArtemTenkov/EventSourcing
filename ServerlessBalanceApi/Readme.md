...
Once you have edited your template and code you can use the following command lines to deploy your application from the command line (these examples assume the project name is *ServerlessBalanceApi*):

Restore dependencies
```
    cd "ServerlessBalanceApi"
    dotnet restore
```

Execute unit tests
```
    cd "ServerlessBalanceApi/test/ServerlessBalanceApi.Tests"
    dotnet test
```

Deploy application
```
    cd "ServerlessBalanceApi/src/ServerlessBalanceApi"
